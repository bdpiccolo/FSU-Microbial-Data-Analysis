...
knitr::include_graphics("./images/plot_tags_time-1-768x768.png")
```
...
knitr::include_graphics("./images/phyloseq.png")
```
...
```{r csvexample}
# Data is in a subfolder, so can use '.\\Dir\\' to reach.
# The '.' denotes the working directory
CSVimport <- read.csv(".\\Data\\CSVexample.csv")
...
# Import Excel file from subfolder
XLSXimport <- read_xlsx(".\\Data\\XLSXexample.xlsx")
XLSXimport
```
...
### apply family of functions {#applyfunctions}
...
### _t_-test and Mann Whitney U test {#ttestexamp}
...
knitr::include_graphics("./images/ttesthelp.png")
```
