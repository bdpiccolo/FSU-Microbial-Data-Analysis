...
As detailed in Chapter \@ref(microbefiles), you may receive your sequencing data as a biom file or in a text-delimited/spreadsheet format.  Let's detail how each can be imported into R
